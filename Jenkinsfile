node ("default-java") {
    ...
    stage('Prepare') {
        ...
        copyArtifacts(projectName: "engine/develop", filter: "templates/build.gradle", flatten: true, selector: lastCompleted())
        copyArtifacts(projectName: "engine/develop", filter: "*, gradle/wrapper/**, config/**, natives/**", selector: lastCompleted())
